...
export const metadata: Metadata = {
	...
	description:
		"Premium high-protein meals designed for athletes and hustlers. Gym pickup and fast delivery across Tunisia. Fuel your body with Sa7a Box.",
	keywords: [
	...
	openGraph: {
		...
		description:
			"Fuel your hustle with premium high-protein meals. Gym pickup & fast delivery across Tunisia.",
		images: [
			{
				url: "/og-image.jpg",
				width: 1200,
	...
	twitter: {
		...
		description:
			"Premium high-protein meals for athletes. Gym pickup & fast delivery across Tunisia.",
		images: ["/og-image.jpg"],
		creator: "@sa7abox",
	},
	robots: {
...
const jsonLd = {
	...
	name: "Sa7a Box",
	description:
		"Premium high-protein meals for athletes and hustlers with gym pickup and fast delivery across Tunisia.",
